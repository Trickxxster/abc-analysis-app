...
days_in_report = st.sidebar.number_input(
    ...
    help="Используется для расчёта среднедневных продаж из столбца «Количество» (продано за период)."
)
...
if uploaded_file is not None:
    ...
    with tab2:
        ...
        if selected_city:
            ...
            display_cols = ['Товар', 'Остаток', 'Продано за период', 'В пути',
                            'К заказу', 'Категория ABC']
            ...
            edited_df = st.data_editor(
                ...
                disabled=['Товар', 'Остаток', 'Продано за период', 'В пути', 'Категория ABC'],
